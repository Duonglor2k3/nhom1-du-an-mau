    ...
    <div class="container">
        <header>
            ...
            <section>
                <div class="header__banner__logo">
                    <div class="header__banner__logo__img">
                        <img src="http://localhost/nhom1-du-an-mau/content/img/logo.png" alt="">
                    </div>
                    <div class="header__banner__logo__form">
                        <form action="" class="search" method="post">
                            <input type="text" class="searchTerm" placeholder="Bạn muốn tìm gì?">
                        </form>
                        <a href=""><img src="http://localhost/nhom1-du-an-mau/content/img/search.png" alt=""></a>
                    </div>
            ...
            <section>
                ...
                <div class="banner">
                    <img src="http://localhost/nhom1-du-an-mau/content/img/banner.png" alt="">
                </div>
            </section>
        </header>
        <main>
